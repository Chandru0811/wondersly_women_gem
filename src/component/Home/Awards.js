  ...
  return (
    <section className="awards py-5">
      <div className="container ">
        <div className="row ">
          <h1 className="awardstitle py-5">Awards & Recognitions</h1>
